...
@requestpriority_bp.get('/<int:request_id>')
...
@requestpriority_bp.put('/<int:request_id>')
...
@requestpriority_bp.patch('/<int:request_id>')
...
@requestpriority_bp.delete('/<int:request_id>')
